...
\sffamily\fboxrule.1em\fboxsep1em \fcolorbox{teal}{teal!50}{\color{black}
...
Considering this, both models performed well throughout our analysis. To highlight a few key results, both models determined that houses which were newer, had larger lot areas, and a higher number of bedrooms were more likely to be above average price than below. Model 1 also indicated that houses sold during peak buying seasons (such as spring and summer) had a higher probability of selling for above average price than below average price, compared to winter and autumn. 
